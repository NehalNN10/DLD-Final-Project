...
HD_PWD='C:/Users/Dell/Documents/uni_docs/cs/dld/project_stuff/dld_final_project/dld_final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PetahDraw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PetahDraw.tcl -notrace
