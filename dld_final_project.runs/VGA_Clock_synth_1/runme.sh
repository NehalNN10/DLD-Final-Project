...
HD_PWD='C:/Users/Dell/Documents/uni_docs/cs/dld/project_stuff/dld_final_project/dld_final_project.runs/VGA_Clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_Clock.tcl
