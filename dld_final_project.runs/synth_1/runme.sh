...
HD_PWD='C:/Users/Dell/Documents/uni_docs/cs/dld/project_stuff/dld_final_project/dld_final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PetahDraw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PetahDraw.tcl
