...
#
# Generated by export_simulation on Fri Nov 17 12:40:37 +0500 2023
#
################################################################################
...
'-reset_run' switch to the './VGA_Clock.sh' script.

./VGA_Clock.sh -reset_run
...
./VGA_Clock.sh -noclean_files

For more information on the script, please type './VGA_Clock.sh -help'.
